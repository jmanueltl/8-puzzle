...
class Driver:
    ...
    def __init__(self, initial_state, goal_state, nodes_expanded, 
                 max_search_depth, max_frontier_size,board_len, board_side):
...
def bfs(start_state, goal_state, max_frontier_size):
    global goal_node, nodes_expanded, max_search_depth
...
def dfs(start_state, goal_state, max_frontier_size):
...
def ast(start_state, goal_state, max_frontier_size):
    ...
    while heap:
        ...
        for neighbor in neighbors:
            ...
            neighbor.key = neighbor.cost + h(neighbor.state, goal_state)
...
def backtrace(initial_state,moves):
...
def export(frontier, time, initial_state, moves):

   
    moves = backtrace(initial_state, moves)
...
def read(configuration, initial_state):
...
def main():
    ...
    read(args.board, initial_state)
    function = function_map[args.algorithm]

    start = timeit.default_timer()

    frontier = function(initial_state, goal_state, max_frontier_size)

    stop = timeit.default_timer()
    
    export(frontier, stop-start, initial_state, moves)
